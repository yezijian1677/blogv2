...
<script src="/js/back/js/bootstrap.min.js"></script>
<script src="/js/back/js/admin-scripts.js"></script>
<script src="/js/back/lib/ueditor/ueditor.config.js"></script>
<script src="/js/back/lib/ueditor/ueditor.all.min.js"> </script>
<script src="/js/back/lib/ueditor/lang/zh-cn/zh-cn.js"></script>
